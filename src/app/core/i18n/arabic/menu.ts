export const menuTranslations = {
  ...
  story: {
    ...
    body: 'فوزي الكبابجي اكثر من ٣٠ سنة خبرة في المشويات و الاكل الشرقي. يميزنا الجودة و التميز في منيو الشرقي بشهادة كل الخبراء و عملاءنا علي مدار اكثر من ربع قرن.',
